...
class URLPlaylistEntry(BasePlaylistEntry):
    ...
    async def _really_download(self, *, hash=False):
        ...
        if result is None:
            log.critical("ytdlp has failed, everyone panic")
            raise ExtractionError("ytdlp broke and hell if I know why")
            # What the fuck do I do now?

        self.filename = unhashed_fname = self.playlist.downloader.ytdlp.prepare_filename(result)
