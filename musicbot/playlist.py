...
class Playlist(EventEmitter, Serializable):
    ...
    async def add_entry(self, song_url, **meta):
        ...
        entry = URLPlaylistEntry(
            ...
            self.downloader.ytdlp.prepare_filename(info),
            **meta
        )
    ...
    async def add_stream_entry(self, song_url, info=None, **meta):
        if info is None:
            ...
            try:
                ...
                if e.exc_info[0] == UnsupportedError:  # ytdlp doesn't like it but its probably a stream
            ...
            if item:
                try:
                    entry = URLPlaylistEntry(
                        ...
                        self.downloader.ytdlp.prepare_filename(item),
                        **meta
                    )
